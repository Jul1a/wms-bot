# Django settings for WMSMash project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'wmstest',                      # Or path to database file if using sqlite3.
        'USER': 'julia',                      # Not used with sqlite3.
...
MEDIA_ROOT = rel_path('tree/templates/')
...
SECRET_KEY = 'n%)226wj*n_%ga8wkt2p#0*_mwa-=zcfhz!#9&-p=^=1cb5*#&'
